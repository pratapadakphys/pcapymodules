...
class LFApplication:
    ...
    def wavelength(self, value):
        if isinstance(value, self.NumberTypes):
            self._set_center_wavelength(value)
            
        elif isinstance(value, tuple):
            self._set_step_and_glue(value[0], value[1])
    ...
    def _set_center_wavelength(self, center_wave_length):
    ...
    def _set_step_and_glue(self, start_wave_length=None, end_wave_length=None): 
    ...
    def _set_configuration(self, config = None):
    ...
    def acquire(self,  filename=None, config = None):
        if config is not None:
