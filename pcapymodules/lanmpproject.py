...
class MeasurementConfiguration:
    def __init__(self, lens, measurement_type, exposure_time = None, wavelength = None, roi = None, average = None, grating = None,  grating_list = ['[500nm,1200][0][0]','[500nm,600][1][0]','[500nm,300][2][0]'], light_source = None, input_path = None, output_path = None):
        self.lens = lens
